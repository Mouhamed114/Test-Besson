...
//    }
   ...
   public function findOneByZoneAndIdCliendAndDepartement($zone, $idClient, $departement ): ?Tarif
   {
       return $this->createQueryBuilder('t')
           ->where('t.idClient = :idClient')
           ->andWhere('t.zone = :zone')
           ->andWhere('t.codeDepartement = :departement')
           ->setParameters(array('zone'=> $zone, 'idClient' => $idClient, 'departement' => $departement))
           ->getQuery()
           ->getOneOrNullResult()
       ;
   }
